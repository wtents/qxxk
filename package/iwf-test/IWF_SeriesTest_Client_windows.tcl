...
proc check_ethernet {} {
	...
	while { 1 } {
		...
		if {[string match $res "yes"]==1} {
			if {[catch {set pingres [exec ping -n 3 "$::serverip"]} err]} {
				set ::var9_log "Error:$err"
				lappend netstats "port$i:FAIL"
			} else {
#				set pingdata [lindex [split $pingres '\n'] 7]
				set pingdata [llength [lindex [split $pingres '\n'] 4] ]
#				set pingdata_recv [string index [lindex [split $pingdata '='] 2] 1]
#				set pingdata_lose [string index [lindex [split $pingdata '='] 3] 1]
				if {$pingdata>=5} {
...
grid .check_cpu_label -row 4 -column 1 -sticky nsew
grid .check_cpu_status -row 4 -column 2 -sticky nsew
grid .check_cpu_log -row 4 -column 3 -sticky nsew
grid .check_ram_label -row 5 -column 1 -sticky nsew
grid .check_ram_status -row 5 -column 2 -sticky nsew
grid .check_ram_log -row 5 -column 3 -sticky nsew
grid .check_pci_label -row 6 -column 1 -sticky nsew
grid .check_pci_status -row 6 -column 2 -sticky nsew
grid .check_pci_log -row 6 -column 3 -sticky nsew
grid .check_usb_label -row 7 -column 1 -sticky nsew
grid .check_usb_status -row 7 -column 2 -sticky nsew
grid .check_usb_log -row 7 -column 3 -sticky nsew
#grid .check_uart_label -row 8 -column 1 -sticky nsew
#grid .check_uart_status -row 8 -column 2 -sticky nsew
#grid .check_uart_log -row 8 -column 3 -sticky nsew
grid .check_led_label -row 9 -column 1 -sticky nsew
grid .check_led_status -row 9 -column 2 -sticky nsew
grid .check_led_log -row 9 -column 3 -sticky nsew
grid .check_button_label -row 10 -column 1 -sticky nsew
grid .check_button_status -row 10 -column 2 -sticky nsew
grid .check_button_log -row 10 -column 3 -sticky nsew
grid .check_flash_label -row 11 -column 1 -sticky nsew
grid .check_flash_status -row 11 -column 2 -sticky nsew
grid .check_flash_log -row 11 -column 3 -sticky nsew
grid .check_ethernet_label -row 12 -column 1 -sticky nsew
grid .check_ethernet_status -row 12 -column 2 -sticky nsew
grid .check_ethernet_log -row 12 -column 3 -sticky nsew
grid .check_wireless_label -row 13 -column 1 -sticky nsew
grid .check_wireless_status -row 13 -column 2 -sticky nsew
grid .check_wireless_log -row 13 -column 3 -sticky nsew
