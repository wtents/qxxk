...
ar8327_hw_init(struct ar8216_priv *priv)
{
	...
	t = ar8327_get_pad_cfg(pdata->pad0_cfg);
        ...
        printk(KERN_INFO "DEBUG[QCA8337] ar8327_hw_init: ori pad0=0x%x, and adjust b26 for IWF503 reg 0x4\n", t);
	t = 0x07680000; /* KenC try, suggested 0x05600000, should keep trying */
	priv->write(priv, AR8327_REG_PAD0_MODE, t);

	t = ar8327_get_pad_cfg(pdata->pad5_cfg);
	printk(KERN_INFO "DEBUG[QCA8337] ar8327_hw_init: ori pad5=0x%x, and adjust as 0x0\n", t);
	t = 0x0;	/* KenC try, suggested 0x01000000, should keep trying */
	priv->write(priv, AR8327_REG_PAD5_MODE, t);

	t = ar8327_get_pad_cfg(pdata->pad6_cfg);
	printk(KERN_INFO "DEBUG[QCA8337] ar8327_hw_init: ori pad6=0x%x, and adjust as 0x01000000\n", t);
	t = 0x01000000;	/* KenC try, suggested 0x01000000, should keep trying */
