...
/* KenC adjust for IWF503 */
 //-------------------------------------------
 #define AP135_GPIO_LED_STATUS_GREEN	19	//kevin
 #define AP135_GPIO_LED_USB		4	//kevin
 //--------------------------------------------
 #define AP135_GPIO_LED_WLAN_2G		13
 #define AP135_GPIO_LED_STATUS_RED      14
 #define AP135_GPIO_LED_WPS_RED         15
 #define AP135_GPIO_LED_RSSI_LO         20
 #define AP135_GPIO_LED_RSSI_MD         21
 #define AP135_GPIO_LED_RSSI_HI         22

 #define AP135_GPIO_BTN_WPS             17
...
static struct gpio_led ap135_leds_gpio[] __initdata = {
	...
	{
		.name		= "ap135:green:wlan-2g",
		.gpio		= AP135_GPIO_LED_WLAN_2G,
		.active_low	= 1,
	},
	{
		.name		= "ap135:green:rssi-lo",
		.gpio		= AP135_GPIO_LED_RSSI_LO,
		.active_low	= 1,
	},
	{
		.name		= "ap135:green:rssi-md",
		.gpio		= AP135_GPIO_LED_RSSI_MD,
		.active_low	= 1,
	},
	{
		.name		= "ap135:green:rssi-hi",
		.gpio		= AP135_GPIO_LED_RSSI_HI,
		.active_low	= 1,
	},
};
...
/* KenC try QCA9558 vs QCA8337 */
#if 0
	t |= QCA955X_ETH_CFG_RGMII_GMAC0;
#else
	t = 0x00028001;		// Suggested to be 0x00028001
#endif
